...
(function () {
  ...
  (function injectCss() {
    var css =
      ...
      "@media(max-width:950px) and (orientation:landscape){.main-content,.app-main,.container{padding:6px!important}.form-grid:not(#invoiceStatusFilterGrid):not(#distributorFilterGrid){grid-template-columns:repeat(2,minmax(0,1fr))!important}.form-grid>.form-group{grid-column:auto!important}.form-grid>.full-width{grid-column:1/-1!important}.map-container,.map-container-large{height:260px!important}.side-menu-drawer{width:min(55vw,360px)!important}}";
  ...
  function runtimeVersion(){
    ...
    return m?decodeURIComponent(m[1]):"11.30.0";
  }

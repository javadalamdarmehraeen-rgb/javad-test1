...
(function () {
  ...
  function runtimeVersion(){
    ...
    return m?decodeURIComponent(m[1]):"11.37.0";
  }
  ...
  function bindDomOrderLock(){document.addEventListener("change",function(e){if(e.target&&e.target.closest&&e.target.closest("#columnsDesignerHost,#manualDesignCanvas,.col-order-input,.col-listorder-input"))setTimeout(captureDomFieldOrder,250);},true);document.addEventListener("click",function(e){if(e.target&&e.target.closest&&e.target.closest("#btnManSave"))setTimeout(captureDomFieldOrder,350);},true);setTimeout(function(){restoreConfiguredFieldVisibility(document);restoreDomFieldOrder();},250);setTimeout(function(){restoreConfiguredFieldVisibility(document);restoreDomFieldOrder();},1600);setTimeout(function(){restoreConfiguredFieldVisibility(document);restoreDomFieldOrder();},2800);}

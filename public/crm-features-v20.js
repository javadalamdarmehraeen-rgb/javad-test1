...
(function () {
  ...
  function runApplyDiagnosisV43(){var host=$("v41DiagHost"),problems=[],acts=[],html="";
  ...
  if(stale){problems.push("کد اجراشده در مرورگر با نسخه سرور هم‌خوان نیست — کش/SW قدیمی یا خطای بارگذاری.");acts.push("پاک‌سازی خودکار کش/SW و بارگذاری مجدد اجباری + ارسال علت برای هوش مصنوعی.");host.innerHTML=html+"<div style='margin-top:8px;color:#b91c1c;font-weight:700'>تشخیص: نسخه مرورگر قدیمی است — الان خودکار اصلاح می‌شود…</div>";report();setTimeout(function(){location.replace("/cache-reset?to=/panel");},1200);return;}
  ...
  host.innerHTML=html+"<div style='margin-top:10px;text-align:right'><b>مشکل:</b> "+problems.join(" | ")+"<br><b>اقدام انجام‌شده:</b> "+acts.join(" | ")+"</div>";
  }).catch(function(){host.innerHTML=html+"<div style='color:#b91c1c'>سرور پاسخ نداد — اتصال را بررسی کنید.</div>";});}

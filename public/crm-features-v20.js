...
(function () {
  ...
  function privacyList(list,permissionKey){var u=v20CurrentUser(),manager=v20IsManager(),perms=(u&&u.permissions)||{};if(manager||perms[permissionKey]===true)return(list||[]).slice();return(list||[]).filter(function(r){return u&&((r.repId&&String(r.repId)===String(u.id))||String(r.repName||r.name||"")===String(u.fullName||""));});}
  ...
  function onTabChanged(id) {
    ...
    if (id === "tab-sales-targets") setTimeout(function(){if(typeof window.renderSalesTargetsTable==="function")window.renderSalesTargetsTable();renderTargetsV20();},120);

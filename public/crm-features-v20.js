...
(function () {
  ...
  var V41_CHANGES=[
    ...
    ["داروخانه: فیلدهای پلاک و طبقه زیر آدرس + نوع داروخانه (شبانه‌روزی/روزانه/بیمارستانی/نیمه‌وقت)","pending"],
    ["داروخانه: تایید بله/خیر هنگام ذخیره + جلوگیری ثبت تکراری (استان/شهر/منطقه/مسئول/همراه/ثابت یکسان)","pending"],
    ["داروخانه/پزشک: خالی‌شدن خودکار فرم هنگام خروج و بازگشت به تب + کلید پاک کردن در بالای صفحه","pending"],
    ["ستون شماره همراه لیست داروخانه مقدار درست (همrschein مسئول) نشان دهد + خروجی اکسل همه ستون‌ها و وسط‌چین","pending"],
    ...
    ["فعالیت/رصد/موقعیت زنده/اسنپ: فیلد کشویی نام نماینده — نماینده: ثابت؛ سرپرست/کارشناس: کشویی با «همه نمایندگان»","pending"],
    ...
    ["فروش پخش‌ها: فیلترها در یک سطر قفل‌شده","pending"],
    ...
    ["اعلان: ریسه فیلدها و پرش صفحه","pending"],
  ...
  function setupV37FinalGuards(){setupChangeLogTabV41();enforceDeletedUserTombstonesV37();enforceRemovedIdentitiesV40();installReferenceInstantAddGuardV40();installPersianBuiltinLabelGuardV37();setupPlainRecipientV37();bindComboCaretFixV37();bindOrderPharmacyCardV37();pinRepresentativeRouteFieldsV37();window.renderRepHomesTable=renderRepHomesV37;renderRepHomesV37();}

...
(function () {
  ...
  function runtimeVersion(){
    ...
    return m?decodeURIComponent(m[1]):"11.36.0";
  }
  ...
  function onTabChanged(id) {
    ...
    v20ApplyGreyChains();
    if (id === "tab-orders") { v20ApplyOrderLock(); bindOrderItemRuntime(); setTimeout(function(){v20PlaceMatchNearInput();applyOrderItemRoleControls();if(typeof window.updateOrderTotalAmountDisplay==="function")window.updateOrderTotalAmountDisplay();},60); }
    ...
    if (id === "tab-rep-homes") setTimeout(function(){if(typeof window.renderRepHomesTable==="function")window.renderRepHomesTable();},80);
    ...
    if (id === "tab-notifications") setTimeout(setupNotificationCenterV35,80);
    if (id === "tab-sales-targets") setTimeout(function(){setupRepresentativeRoutes();setupTargetPlannerV34();},120);

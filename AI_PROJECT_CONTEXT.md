...
نسخه سورس 12.13.0 (نوبت ۱۲۸): سه نقص واقعیِ نسخه روی گیت‌هاب رفع شد — نسخه در ۹ فایل
...
`نسخه 12.13.0` با ارقام لاتین / `طنین طب طاها  TANIN TEB TAHA`، و با MutationObserver

...
## نوبت ۱۲۸ — نسخه ۱۲.۱۲.۰ (تحویل‌شده)

- [x] یکسان‌سازی نسخه `12.13.0` در ۹ فایل کد/دارایی/PHP
- [x] ساخت `public/index.php` + ثبت در `OFFICIAL_FILELIST.txt`
- [x] به‌روزرسانی انتظارات تست‌ها (۹۱ الگو) + اصلاح ۵ آزمون قدیمی
- [x] سربرگ سه‌خطی کنار لوگو با ارقام لاتین + قفل با MutationObserver
- [x] لایه بدون VPN: تایم‌اوت ۶ ثانیه، بدون انتظار در بوت، پیام نقشه، تایم‌اوت ژئوکد
- [x] ثبت دامنه `ndcohub.com` در ۱۱ فایل و همگام سه‌دامنه (مرورگر + PHP)
- [x] ۵ آزمون تازه + ۴ آزمون اجرایی (runtime) برای لایه ۱۲.۱۲.۰
- [x] تست ۱۳۸/۱۳۹ + app-smoke ۴/۴ + build-static موفق + سرور واقعی health 12.13.0
- [ ] تأیید `index.php` روی هاست واقعی نت‌افراز (در این محیط PHP نبود)
- [ ] تأیید production پس از push کاربر (`/api/health` باید 12.13.0 بگوید)

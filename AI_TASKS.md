...
- [x] یکسان‌سازی نسخه `12.14.0` در ۹ فایل کد/دارایی/PHP
...
- [x] تست ۱۳۸/۱۳۹ + app-smoke ۴/۴ + build-static موفق + سرور واقعی health 12.14.0
- [ ] تأیید `index.php` روی هاست واقعی نت‌افراز (در این محیط PHP نبود)
- [ ] تأیید production پس از push کاربر (`/api/health` باید 12.14.0 بگوید)

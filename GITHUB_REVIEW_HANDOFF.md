...
**تاریخ این تحویل:** 2026-09-08 / ۱۷ شهریور 1405 (به‌روزرسانی نوبت ۱۴۴)
**نسخه آماده سورس:** `12.19.0` (فایل واحد crm-bundle با لایه‌های تا v12.18 + لایهٔ پایانیِ `public/crm-v12.19.0.js` + موتورِ ورودِ crm-entry-engine.js + مویرگِ همگامِ چنددستگاهی — فایل‌های crm-features-v9 تا v20 حذف شده‌اند)

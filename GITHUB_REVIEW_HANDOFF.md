...
**تاریخ این تحویل:** 2026-09-05 / ۱۴ شهریور 1405 (به‌روزرسانی نوبت ۱۳۲)
**نسخه آماده سورس:** `12.17.1` (فایل واحد crm-bundle با لایه‌های تا v12.17 — فایل‌های crm-features-v9 تا v20 حذف شده‌اند)

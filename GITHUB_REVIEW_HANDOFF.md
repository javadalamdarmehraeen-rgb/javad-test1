...
**تاریخ این تحویل:** 2026-09-07 / ۱۶ شهریور 1405 (به‌روزرسانی نوبت ۱۴۱)
**نسخه آماده سورس:** `12.18.5` (فایل واحد crm-bundle با لایه‌های تا v12.18 + موتورِ ورودِ crm-entry-engine.js + مویرگِ همگامِ چنددستگاهی — فایل‌های crm-features-v9 تا v20 حذف شده‌اند)

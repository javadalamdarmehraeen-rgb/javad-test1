...
**نسخه آماده سورس:** `12.20.0` (فایل واحد crm-bundle با لایه‌های تا v12.18 + لایهٔ پایانیِ `public/crm-v12.20.0.js` + موتورِ ورودِ crm-entry-engine.js + مویرگِ همگامِ چنددستگاهی — فایل‌های crm-features-v9 تا v20 حذف شده‌اند)
...
رفع (لایهٔ پایانیِ `public/crm-v12.20.0.js` + چهار ویرایشِ کوچکِ هدفمند):

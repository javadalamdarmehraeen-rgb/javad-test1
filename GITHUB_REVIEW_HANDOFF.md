...
**نسخه آماده سورس:** `12.18.2` (فایل واحد crm-bundle با لایه‌های تا v12.18 + موتورِ ورودِ crm-entry-engine.js — فایل‌های crm-features-v9 تا v20 حذف شده‌اند)
**نسخه chat.arena پس از بازسازی این نوبت:** `2.19`

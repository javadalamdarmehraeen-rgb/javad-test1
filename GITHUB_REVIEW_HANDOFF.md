...
منتظر:                    pushِ شاخه توسط کاربر + Mergeِ PR #8 (توکنِ GitHubِ شنی‌باکس منقضی شده) → بعد از Merge، Render/نت‌افراز خودکار 12.18.0 می‌شوند.
```

...
const htaccess = [
  ...
  "",
  "# v12.14.0: دارایی‌های نسخه‌دار یک سال immutable؛ رفرش دیگر burst ایجاد نمی‌کند",
  "<IfModule mod_rewrite.c>",
  "RewriteEngine On",
  "RewriteCond %{QUERY_STRING} (^|&)v=[0-9]",
  "RewriteRule ^ - [E=CRM_VERSIONED:1]",
  "</IfModule>",
  "<IfModule mod_headers.c>",
  "  <FilesMatch \"\\.(js|css|png|jpe?g|webp|svg|woff2?|ico)$\">",
  "    Header set Cache-Control \"public, max-age=31536000, immutable\" env=CRM_VERSIONED",
  "  </FilesMatch>",
  "</IfModule>",
  "</IfModule>",
  "<IfModule mod_rewrite.c>",

...
### `public/crm-features-v11.js` (107737 بایت)
...
- `mergeStateWithoutLoss`: تعریف/بازنویسی به ترتیب لود → `public/crm-app.js` ← `public/crm-features-v20.js`
...
- `CRM_APP_STATE_MERGED_RECOVERY` ← localStorage: `public/crm-app.js`
...
- `v20RecoveryShown` ← sessionStorage: `public/crm-features-v20.js`
...
- `public/crm-features-v20.js` → 7 شناسه (مثل: `btnSaveProduct`, `formProduct`, `productDistPrice`, `productName`, `productPrice`, `productSavedBanner`, `productStock`)
...
- `public/crm-features-v20.js` → 25 شناسه (مثل: `btnBuildSnappReport`, `btnBuildSnappTopupReport`, `btnExportSnappTopups`, `btnExportSnappView`, `btnOpenSnappCorporate`, `snappDailyStatus`, `snappFileArchiveViewer`, `snappFilterFrom`)

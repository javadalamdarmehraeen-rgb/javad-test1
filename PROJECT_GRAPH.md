...
- Production فعال: `https://javad-test1.onrender.com` — پس ازِ mergeِ نوبتِ ۱۴۴، `12.19.0` سرو می‌شود (لایهٔ پایانیِ `public/crm-v12.19.0.js`: قفلِ چیدمان + ساعت/تاریخ + خروجیِ کامل + همگامِ ۱۰ ثانیه).

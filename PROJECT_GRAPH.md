...
- نسخه سورس package: `12.18.3`
- مخزن GitHub: `javadalamdarmehraeen-rgb/javad-test1`؛ شاخه اجباری جلسه Arena فعلی: `arena/01a07288-javad-test1`؛ push/PR فقط از همین شاخه (PR #8 به‌روز شده با 12.18.3، منتظر Merge کاربر).
- Production فعال: `https://javad-test1.onrender.com` — تا Merge نشدنِ PR #8 همان `12.16.0` کهنه را سرو می‌کند؛ پس از Merge خودکار `12.18.3`.

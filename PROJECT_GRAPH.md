...
- Production فعال: `https://javad-test1.onrender.com` — پس ازِ mergeِ نوبتِ ۱۴۵، `12.23.0` سرو می‌شود (لایهٔ پایانیِ `public/crm-v12.23.0.js`: قفلِ لنگرِ چیدمان + اعمالِ واقعیِ ایتم‌هایِ طراح + هدرِ فشرده + گاوصندوقِ تنظیمات).

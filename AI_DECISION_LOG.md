...
## 12.11.0
GPS منزل با تلاش دوباره و پلاک/طبقه در جدول V37؛ استان/شهر/منطقه از registry سراسری جدا شد (v1211SkipGeo)؛ درصد افزایش و consVat همان لحظه با باقیمانده درصد؛ همگام ۲ثانیه‌ای با refresh لیست بدون رفرش دستی.

## 12.10.0
GPS منزل پایدار + پلاک/طبقه در لیست؛ جغرافیا قفل؛ قیمت جدید لحظه‌ای از درصد افزایش و consVat با باقیمانده درصد؛ همگام لحظه‌ای last-write-wins بدون پوش هنگام pull.

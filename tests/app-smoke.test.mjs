...
test('automated app entry loads health, HTML, all scripts and critical UI', async () => {
  ...
  for (const id of ['tab-dashboard','tab-orders','tab-snapp-corporate','tab-distributor-companies','tab-distributor-sales','btnToggleSideMenu','snappTripModeYear','snappTopupModeYear','btnBuildDistributorReport']) {

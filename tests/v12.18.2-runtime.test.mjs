...
function baseEnv(opts) {
  ...
  (opts.lsInit || [['CRM_OLD_JUNK', '1'], ['CRM_DIAG_LOG', '[]'], ['CRM_APP_STATE_V2', '{"a":1}'], ['CRM_USERS_AUTH', '[]'], ['CRM_V1218_PURGED', '12.23.0']]).forEach(([k, v]) => ls.setItem(k, v));
...
test('v12.18.3: برابریِ نسخهٔ 12.23.0 در همهٔ سطوح + بنرِ README', () => {
  const VER = '12.23.0';

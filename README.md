...
> # 🏷️ نسخه‌ی جاریِ این ریپو (GitHub main): **12.18.1**
>
> **به‌روزرسانی 2026-09-06 (نوبت ۱۳۷):** اگر در هر کجا (Render، نت‌افراز، ZIP روی دیسک) نسخه‌ای پایین‌تر از `12.18.1` می‌بینید، آن یک deployِ کهنه است؛ سورسِ درست همین ریپو است.
>

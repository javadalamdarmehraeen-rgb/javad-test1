...
> **راهنمای بررسی نسخه جاری:** قبل از هر بررسی GitHub، فایل [`GITHUB_REVIEW_HANDOFF.md`](./GITHUB_REVIEW_HANDOFF.md) و سپس [`PROJECT_GRAPH.md`](./PROJECT_GRAPH.md) را بخوانید. نسخه فعال سورس `11.75.0` است؛ ورودی runtime اصلی `server.js + public/` است و اسکلت Next.js پوشه `src/` مسیر production فعلی نیست.
>
> **وضعیت انتشار در 2026-08-27 (نوبت ۹۳):** سورس `11.75.0` آماده push کاربر است — یک state زنده + پرده تا سرور + ذخیره پایدار تارگت پخش.
...
## 12.12.0
همگام لحظه‌ای ویندوز و گوشی؛ پل نت‌افراز به رندر. هدر مهر آیین نیک دارو و طنین طب طاها TANIN TEB TAHA.

## 12.11.0
موقعیت منزل پایدار با تلاش دوباره؛ پلاک و طبقه در لیست. استان/شهر/منطقه ثابت. درصد افزایش و ویرایش مصرف‌کننده با ارزش افزوده همان لحظه در کادر قیمت جدید. همگام لحظه‌ای ویندوز و گوشی بدون رفرش دستی.

## 12.10.0
موقعیت منزل پایدار با پلاک و طبقه در لیست. استان/شهر/منطقه ثابت. درصد افزایش همان لحظه در کادر قیمت جدید؛ ویرایش مصرف‌کننده با ارزش افزوده با باقیمانده درصد ستون‌ها. همگام لحظه‌ای ویندوز و گوشی بدون رفرش دستی.

...
> **راهنمای بررسی نسخه جاری:** قبل از هر بررسی GitHub، فایل [`GITHUB_REVIEW_HANDOFF.md`](./GITHUB_REVIEW_HANDOFF.md) و سپس [`PROJECT_GRAPH.md`](./PROJECT_GRAPH.md) را بخوانید. نسخه فعال سورس `11.66.0` است؛ ورودی runtime اصلی `server.js + public/` است و اسکلت Next.js پوشه `src/` مسیر production فعلی نیست.
>
> **وضعیت انتشار در 2026-08-26 (نوبت ۸۶):** سورس `11.66.0` آماده push کاربر است — تب تعریف مسیر نمایندگان، تارگت فروش هرپخش، و ZIP استاندارد ویندوز. جزئیات در فایل handoff. دانلود ZIP از پیش‌نمایش پورت 8000 (صفحه فارسی) انجام شود؛ پیش‌نمایش خام ZIP در پنل ممکن است سفید/باینری دیده شود.
